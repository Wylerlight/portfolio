...
const projectData = [
  {
    ...
    photo: pmr,
    website: 'https://main.daclcxc3j6u09.amplifyapp.com/',
    github: 'https://github.com/Wylerlight/pmr-tyler',
    description:
      'A landing page for a Mortgage Broker working independently at Primary Mortgage Resource Corporation.',
  },
  {
    name: 'AppTrack',
    photo: apptrack,
    website: 'https://www.apptrack.pro/',
